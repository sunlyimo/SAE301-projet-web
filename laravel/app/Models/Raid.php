...
class Raid extends Model
{
    public static function getFuturRaid() {
        ...
        ->groupBy("vik_raid.RAI_ID","vik_raid.UTI_ID","vik_utilisateur.UTI_NOM","RAI_NOM" , "RAI_INSCRI_DATE_DEBUT" ,"RAI_INSCRI_DATE_FIN" , "RAI_RAID_DATE_DEBUT" , "RAI_RAID_DATE_FIN" , "RAI_LIEU")
        ->get();
        return $raids;
    }
