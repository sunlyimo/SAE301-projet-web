                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-8">
                        ...
                        <div class="flex flex-col gap-2 group">
                            <label class="text-sm font-bold text-gray-500 uppercase tracking-wide flex justify-between">
                                Nom
                                <button type="button" onclick="toggleField('UTI_NOM')" class="text-black hover:text-green-600 transition-colors">
                        ...
                        <div class="flex flex-col gap-2 group">
                            <label class="text-sm font-bold text-gray-500 uppercase tracking-wide flex justify-between">
                                Prénom
                                <button type="button" onclick="toggleField('UTI_PRENOM')" class="text-black hover:text-green-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                    </svg>
                                </button>
                ...
                <div class="border-t border-gray-100 pt-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-8">
                        ...
                        <div class="flex flex-col gap-2 group">
                            <label class="text-sm font-bold text-gray-500 uppercase tracking-wide flex justify-between">
                                Email
                                <button type="button" onclick="toggleField('UTI_EMAIL')" class="text-black hover:text-green-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                    </svg>
                                </button>
                        ...
                        <div class="flex flex-col gap-2 group">
                            <label class="text-sm font-bold text-gray-500 uppercase tracking-wide flex justify-between">
                                Rue
                                <button type="button" onclick="toggleField('UTI_RUE')" class="text-black hover:text-green-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                    </svg>
                                </button>
                        ...
                        <div class="flex flex-col gap-2 group">
                            <label class="text-sm font-bold text-gray-500 uppercase tracking-wide flex justify-between">
                                Code Postal
                                <button type="button" onclick="toggleField('UTI_CODE_POSTAL')" class="text-black hover:text-green-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                    </svg>
                                </button>
                        ...
                        <div class="flex flex-col gap-2 group">
                            <label class="text-sm font-bold text-gray-500 uppercase tracking-wide flex justify-between">
                                Ville
                                <button type="button" onclick="toggleField('UTI_VILLE')" class="text-black hover:text-green-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                    </svg>
                                </button>
                        ...
                        <div class="flex flex-col gap-2 group">
                            <label class="text-sm font-bold text-gray-500 uppercase tracking-wide flex justify-between">
                                Téléphone
                                <button type="button" onclick="toggleField('UTI_TELEPHONE')" class="text-black hover:text-green-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                    </svg>
                                </button>
