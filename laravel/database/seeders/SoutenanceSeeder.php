...
class SoutenanceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $utilisateurs = [
            ...
            [59, 'thomas.leroy@gmail.com', 'LEROY', 'Thomas', '1995-08-30', '102 rue du Moulin', '77500', 'Chelles', '0633571288', '', 'thomas.leroy', 'pass123'],
            [60, 'julie.garnier@outlook.com', 'GARNIER', 'Julie', '1988-07-12', '3 place de la Mairie', '77000', 'Melun', '0765901122', '', 'julie.garnier', 'pass123'],
            ...
            [63, 'lea.caron@test.fr', 'CARON', 'Lea', '1990-04-27', '4 rue des Esses', '25140', 'Montbéliard', '0614253647', '', 'lea.caron', 'pass123'],
            ...
            [67, 'julie.jacquier@unicaen.fr', 'JACQUIER', 'Yohann', '2013-06-03', '35 rue des roses', '14123', 'IFS', '0642864628', '', 'julie.jacquier', 'pass123'],
        ...
        DB::table('vik_raid')->insert([
            ...
            [
                ...
                'RAI_INSCRI_DATE_DEBUT' => '2026-01-09 00:00:00',
